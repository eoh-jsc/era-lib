...
typedef struct __CompareRsp_t : std::binary_function<Response_t, Response_t, bool> {
...
typedef struct __CheckAFdata_t : std::binary_function<Response_t, Response_t, bool> {
    const Response_t& rsp;
    const Response_t& wait;
...
typedef struct __CheckRsp_t : std::binary_function<Response_t, Response_t, bool> {
    const Response_t& rsp;
    const Response_t& wait;
...
typedef struct __CheckInfoCoordinator_t : std::unary_function<InfoCoordinator_t, bool> {
...
typedef struct __find_deviceWithNwkAddr_t : std::unary_function<IdentDeviceAddr_t, bool> {
	uint16_t nwkAddr;
...
typedef struct __find_deviceWithIEEEAddr_t : std::unary_function<IdentDeviceAddr_t, bool> {
...
typedef struct __find_endpoint_t : std::unary_function<InfoEndpoint_t, bool> {
