#ifndef INC_DEFINE_COMMON_ZIGBEE_HPP_
#define INC_DEFINE_COMMON_ZIGBEE_HPP_
...
namespace ZigbeeNamespace {
    ...
    enum ResultT {
        RESULT_SUCCESSFUL = 0x00,
        RESULT_FAIL = 0x01,
        RESULT_TIMEOUT = 0x03,
        RESULT_READ_DONE = 0x04
    };

    enum ZnpCommandStatusT {
        SUCCESS_STATUS = 0x00,
        FAILURE_STATUS = 0x01,
        INVALID_PARAM = 0x02,
