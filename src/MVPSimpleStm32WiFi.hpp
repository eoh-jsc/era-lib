#ifndef INC_MVP_SIMPLE_STM32_WIFI_HPP_
#define INC_MVP_SIMPLE_STM32_WIFI_HPP_

#include <Adapters/MVPWiFiClient.hpp>
...
MVPWiFi mvp(mqtt, flash);

#endif /* INC_MVP_SIMPLE_STM32_WIFI_HPP_ */