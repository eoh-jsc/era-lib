#ifndef INC_MVP_PARSE_HPP_
#define INC_MVP_PARSE_HPP_
...
public:
    ...
    size_t sensorCount;
    MVPList<SensorDelay_t> sensorDelay;
    size_t readConfigCount;
    MVPList<ModbusConfig_t> modbusConfigParam;
    size_t readConfigAliasCount;
    MVPList<ModbusConfigAlias_t> modbusConfigAliasParam;

    TimerDelay_t requestDelay;
    TimerDelay_t modbusDelay;
    TimerDelay_t pushDelay;

    static MVPApplication config;
    static MVPApplication control;
